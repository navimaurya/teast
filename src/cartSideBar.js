        ...
        <div>
            ...
            <hr />
            {
                cartItems.length ? <>
                    ...
                    : <div className='w-100 d-flex text-center' style={{ justifyContent: 'center', minHeight: '60vh', flexDirection: 'column', backgroundImage: 'src(https://www.pngplay.com/wp-content/uploads/7/Cart-Transparent-Free-PNG.png)' }}>
                        <img src='https://www.pngplay.com/wp-content/uploads/7/Cart-Transparent-Free-PNG.png' alt='...' />
